...
$(()=>{
    // $("#btnn").click(() => {
    //   $("#resim").attr("src", `${images}`);
    // });
    $("#btn2").click(()=>{
        // $("body").append(`<img src='${resim}' id="resim" />`);
        $("#resim").attr("src", `${images["as"]}`);
    });
});

},{"./import-jquery.js":"5NpfD"}],"5NpfD":[function(require,module,exports) {
...
},{}]},["6IXwR","bNKaB"], "bNKaB", "parcelRequirecf5d")
